## ⚠️ Heads up: This repo is a fork from Medium's internal tool Snowflake!
[Read more about their current thinking around engineer growth](https://medium.engineering/engineering-growth-at-medium-4935b3234d25).
...
You are free to use, change and build on this work to make it useful for your organisation. This repo is a demonstration of how AI Coding IDE's can help fix, upgrade and modernize legacy codebases. This repo has been updated to use modern dependencies and practices. The original version used Yarn and Flow type checking, which have been removed in favor of npm and plain JavaScript. The repo was last updated in 2019, before the rise of AI Coding IDE's. This repo was updated and modified using Google's new Agentic IDE, AntiGravity. Give it a try yourself.
